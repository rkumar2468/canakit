...
URL_RAW_BASE="https://raw.githubusercontent.com/home-assistant/supervised-installer/main/main/homeassistant-supervised/etc"
URL_VERSION="https://version.home-assistant.io/stable.json"
URL_BIN_APPARMOR="${URL_RAW_BASE}/systemd/system/hassio-apparmor"
URL_BIN_HASSIO="${URL_RAW_BASE}/systemd/system/hassio-supervisor"
URL_DOCKER_DAEMON="${URL_RAW_BASE}/docker/docker_daemon.json"
URL_HA="${URL_RAW_BASE}/ha"
URL_INTERFACES="${URL_RAW_BASE}/network/interfaces"
URL_NM_CONF="${URL_RAW_BASE}/NetworkManager/NetworkManager.conf"
URL_NM_CONNECTION="${URL_RAW_BASE}/system-connections/default"
URL_SERVICE_APPARMOR="${URL_RAW_BASE}/systemd/system/hassio-apparmor.service"
URL_SERVICE_HASSIO="${URL_RAW_BASE}/systemd/system/hassio-supervisor.service"
